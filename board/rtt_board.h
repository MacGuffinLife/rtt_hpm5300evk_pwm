...
#define UH_PIN_NUM GET_PIN(A,30)
#define UL_PIN_NUM GET_PIN(A,31)
#define VH_PIN_NUM GET_PIN(A,28)
#define VL_PIN_NUM GET_PIN(A,29)
#define WH_PIN_NUM GET_PIN(A,26)
#define WL_PIN_NUM GET_PIN(A,27)
#define SD_PIN_NUM GET_PIN(B,9)
